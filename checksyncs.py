...
etcdonly = [ 'cleanlost','ActPool', 'known', 'localrun', 'balancedtype','sizevol', 'alias', 'hostipsubnet', 'allowedPartners','activepool', 'poolsnxt','poolnxt', 'pools', 'logged','ActivePartners','configured','ready', 'pool','nextlead']
