...
if toactivate != []:
 for x in toactivate:
  ...
  put('sync/nextlead/Add_er_'+x[0].replace('toactivate','')+'::'+x[1]+'/request','nextlead_'+str(stamp()))
  put('sync/nextlead/Add_er_'+x[0].replace('toactivate','')+'::'+x[1]+'/request/'+myhost,'nextlead_'+str(stamp()))
