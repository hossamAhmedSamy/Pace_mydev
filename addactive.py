...
if toactivate != []:
 for x in toactivate:
  ...
  put('known/Add_'+x[0].replace('toactivate','')+'_'+x[1]+'/request','known_'+str(stamp()))
  put('known/Add_'+x[0].replace('toactivate','')+'_'+x[1]+'/request/'+myhost,'knwon_'+str(stamp()))
  #broadcasttolocal('known/'+x[0].replace('toactivate',''),x[1])
  put('nextlead',x[0].replace('toactivate','')+'/'+x[1])
  put('nextlead/Add_'+x[0].replace('toactivate','')+'_'+x[1]+'/request','nextlead_'+str(stamp()))
  put('nextlead/Add_'+x[0].replace('toactivate','')+'_'+x[1]+'/request/'+myhost,'nextlead_'+str(stamp()))
